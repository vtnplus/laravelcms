{header}
<?php _panel('<i class="glyphicon glyphicon-envelope"></i> Email Templates',false,'<a href="'.admin_url("stores/email/create/{$type}",false).'" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Create</a> <a href="" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Move Trash</a>');?>
...
<table class="table table-bordered table-hover table-pull">
	<thead>
		<tr>
			<td width="2%">ID</td>
			<td>Subject</td>
	...
	<tbody>
		...
		<tr>
			...
			<td>
             <?php button_tranlation("stores/email/copy/".$value->id."/{language}");?>
            <?php button(["edit" => ["stores/email/edit/".$value->id], "delete" => ["stores/email/delete/".$value->id]]);?></td>
		</tr>
		<?php } ?>
	</tbody>
</table>
